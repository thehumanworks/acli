...
fn global_args() -> Vec<Arg> {
    vec![
        ...
        Arg::new("config")
            ...
            .env(ENV_CONFIG)
            .global(true)
            .help("acli JSON config source; accepts a local path or raw JSON"),
        Arg::new("title")
            .long("title")
            .value_name("TEXT")
            .env(ENV_TITLE)
